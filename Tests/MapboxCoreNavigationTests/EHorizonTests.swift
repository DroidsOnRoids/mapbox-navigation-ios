...
extension EHorizonTests: EHorizonDelegate {
    func didUpdatePosition(_ position: ElectronicHorizonPosition, distances: [String : RoadObjectDistanceInfo]) {
        ...
        _ = try! passiveLocationDataSource.graphAccessor.getEdgeMetadata(forEdgeId: graphPosition.edgeId)
        _ = try! passiveLocationDataSource.graphAccessor.getEdgeShape(forEdgeId: graphPosition.edgeId)
    }
