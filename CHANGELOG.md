...
* Added support for the `UISceneDelegateClassName` Info.plist key for integrating `CarPlayManager` with `UIScene` on iOS 13 and above. ([#2832](https://github.com/mapbox/mapbox-navigation-ios/pull/2832))
